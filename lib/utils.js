...
var utils = module.exports = {
	...
	// pluralize a word
	// temporary measure to get around inflection's incorrect pluralization of "permission" in v1.5.2
	pluralize: function(str) {
		if (str.toLowerCase() == 'permission') return str + 's';
		return Sequelize.Utils.pluralize(str);
	}
};
