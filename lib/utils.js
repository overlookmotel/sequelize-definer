...
module.exports = function(Sequelize) {
	...
	return {
		...
		setNoUndef: function(obj, key, value) {
			if (value === undefined) {
				delete obj[key];
			} else {
				obj[key] = value;
		...
		defaultNoUndef: function(obj, key, value) {
			if (obj[key] !== undefined || value === undefined) return obj;
			obj[key] = value;
			return obj;
		},
		
		// sets all keys from fromObj onto obj, deleting undefined values
		extendNoUndef: function(obj, fromObj) {
		...
		defaultsNoUndef: function(obj, fromObj) {
			_.forIn(fromObj, function(value, key) {
