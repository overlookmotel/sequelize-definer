...
module.exports = function(Sequelize) {
	...
	Sequelize.prototype.defineAll = function(definitions, defineOptions) {
		...
		function prepOne(modelName, definition)
		{
			...
			if (!key) {
				if (!defineOptions.primaryKey) throw new Sequelize.SequelizeDefinerError("Model '" + modelName + "' has no primary key defined");
		...
		function defineOne(modelName, definition)
		{
			...
			utils.defaultNoUndef(options, 'autoAssociate', defineOptions.autoAssociate);
			utils.defaultNoUndef(options, 'labels', defineOptions.labels);
