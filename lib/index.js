		...
		function defineRelationships()
		{
			...
			_.forEach(relationshipsMany, function(options) {
				...
				if (options.through) {
					...
					var modelName = Utils.pluralize(modelName1) + defineOptions.camelThrough ? Utils.uppercaseFirst(modelName2) : modelName2;
					
					options.through = defineOne(modelName, {fields: fields, options: {freezeTableName: defineOptions.freezeTableName}});
				}
