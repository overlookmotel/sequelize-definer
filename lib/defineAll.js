...
module.exports = function(definitions, defineOptions) {
	...
	function prepOne(modelName, definition)
	{
		...
		if (!key) {
			...
			var shouldAutoIncrement = ['INTEGER', 'BIGINT'].indexOf(options.primaryKeyType._typeName) != -1;
			...
			if (options.primaryKeyType == Sequelize.UUID) keyField.defaultValue = Sequelize.UUIDV4;
