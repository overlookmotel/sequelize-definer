			...
			if (reference !== undefined && !reference) {
				...
				if (reference) {
					...
					if (_.endsWith(fieldName, Utils.uppercaseFirst(params.referenceKey))) {
						var as = fieldName.slice(0, -params.referenceKey.length);
				...
				params.referencesKey = params.referenceKey;
				...
				if (!referenceField) throw new Sequelize.SequelizeDefinerError("referenceKey defined in '" + modelName + '.' + fieldName + "' refers to nonexistent field '" + reference + '.' + params.referenceKey + "'");
